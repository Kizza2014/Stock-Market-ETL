...
import os
from crawl_utils import save_to_csv, state_code_look_up
...
class ProfileParser:
    def parse_all_html(self, path):
        ...
        available_html = ["ITUB","NU","NVO","ERIC","BUD","GRAB","TAK","AMCR","JD","RIG","PEP","BP","NOK","PSLV","TEVA","ONON","SATS","RF","MNST","TEM"]
        available_html = [f + "_profile.html" for f in available_html]
        ...
        save_path = os.path.join("test_profile_parser", "all_profiles_parsed.csv")
        save_to_csv(rows_data, schema, save_path)


if __name__ == "__main__":
    path = "./data_test/crawl_profile/crawled_on_2025_08_02/"
